...
export const adminAPI = {
  ...
  adminUpdateMember: (planID: string, memberID: string, shareBasisPoints: number, usdLimitMicros: number | null) => request<Member>(`/api/admin/plans/${planID}/members/${memberID}`, { method: 'PATCH', body: JSON.stringify({ share_basis_points: shareBasisPoints, usd_limit_micros: usdLimitMicros }) }),
