...
export const planAuditActionLabels: Record<string, string> = {
  ...
  'plan.quota_reset_vote_started': '发起了额度重置投票',
  'plan.quota_reset_vote_passed': '投票达到严格多数',
  'plan.quota_reset_vote_cancelled': '取消了额度重置投票',
  'plan.quota_reset_vote_expired': '额度重置投票已过期',
  'plan.quota_reset_vote_interrupted': '额度重置结果需要确认',
