...
func (s *Server) routes() {
	...
	s.mux.Handle("GET /api/membership", s.requireUser(http.HandlerFunc(s.membership)))
	s.mux.Handle("GET /api/membership/orders", s.requireUser(http.HandlerFunc(s.membershipOrders)))
	s.mux.Handle("POST /api/membership/orders", s.requireUser(http.HandlerFunc(s.createMembershipCheckout)))
	s.mux.Handle("POST /api/membership/orders/{orderID}/verify", s.requireUser(http.HandlerFunc(s.verifyMembershipPayment)))
	s.mux.Handle("POST /api/membership/orders/{orderID}/cancel", s.requireUser(http.HandlerFunc(s.cancelMembershipOrder)))
	s.mux.HandleFunc("GET /api/payment/easypay/notify", s.easyPayNotify)
	s.mux.HandleFunc("POST /api/payment/easypay/notify", s.easyPayNotify)
	s.mux.HandleFunc("GET /api/payment/return", s.paymentReturn)
	s.mux.Handle("GET /api/plans/{planID}", s.requireUser(http.HandlerFunc(s.planDetail)))
	s.mux.Handle("GET /api/plans/{planID}/concurrency", s.requireUser(http.HandlerFunc(s.planConcurrency)))
	s.mux.Handle("PUT /api/plans/{planID}/concurrency", s.requireUser(http.HandlerFunc(s.updatePlanConcurrency)))
	...
	s.mux.Handle("GET /api/plans/{planID}/quota/reset-vote", s.requireUser(http.HandlerFunc(s.quotaResetVote)))
	s.mux.Handle("POST /api/plans/{planID}/quota/reset-votes", s.requireUser(http.HandlerFunc(s.createQuotaResetVote)))
	s.mux.Handle("PATCH /api/plans/{planID}/quota/reset-votes/{voteID}", s.requireUser(http.HandlerFunc(s.castQuotaResetVote)))
	...
	s.mux.Handle("GET /api/admin/plans/{planID}/concurrency", admin(s.adminPlanConcurrency))
	s.mux.Handle("PUT /api/admin/plans/{planID}/concurrency", admin(s.adminUpdatePlanConcurrency))
	...
	s.mux.Handle("GET /api/admin/users/{userID}/membership", admin(s.membership))
	s.mux.Handle("GET /api/admin/users/{userID}/membership/orders", admin(s.membershipOrders))
	s.mux.Handle("PATCH /api/admin/users/{userID}/membership", admin(s.adjustMembership))
