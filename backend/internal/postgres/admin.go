...
func (s *Store) AdminListAccounts(ctx context.Context) ([]domain.AdminAccount, error) {
	rows, err := s.pool.Query(ctx, `
		SELECT a.id,a.owner_user_id,a.name,a.notes,a.email,a.chatgpt_account_id,a.plan_type,a.subscription_expires_at,a.proxy_url_ciphertext,a.max_concurrency,a.rpm_limit,a.fast_policy,a.codex_fingerprint_mode,a.state_enabled,a.token_expires_at,a.status,a.last_error,a.created_at,
