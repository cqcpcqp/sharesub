...
| 路径兼容 | 支持 `/v1/models`、`/models`、`/backend-api/codex/models`，三个 Responses/compact 前缀和 Images 前缀 |
...
| Token 与成本指标 | 记录 Input、Output、Cached/Image Token、图片数，并按实际模型、service tier 与图片尺寸计算账号成本 |
